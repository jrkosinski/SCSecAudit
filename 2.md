...
**Issue: Overflow/Underflow** Prior to Solidity version 0.8.0, arithmetic operations on intrinsic numeric types would wrap on underflow/overflow. If not expected by the developer, this could lead to unexpected values which could lead to an exploitable situation. 
